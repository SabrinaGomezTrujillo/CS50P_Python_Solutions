...
diccionario_frutas = {nombre.lower(): calorias for nombre, calorias in lista_frutas}
if item.lower() in diccionario_frutas:
    print(f"Calories: {diccionario_frutas[item.lower()]}")
else:
    print("")
